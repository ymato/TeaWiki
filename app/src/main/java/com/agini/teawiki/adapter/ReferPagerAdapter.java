 ...
 */
public class ReferPagerAdapter extends BaseAdapter {
    private Context mContext;
    private List<Refer.DataBean> mData;
    private MyLruCache myLruCache;
    public ReferPagerAdapter(Context context, List<Refer.DataBean> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView!=null){
            ...
            ret= LayoutInflater.from(mContext).inflate(R.layout.refer_list_item,parent,false);
