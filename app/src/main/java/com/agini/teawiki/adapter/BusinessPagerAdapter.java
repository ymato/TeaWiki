...
public class BusinessPagerAdapter extends BaseAdapter {
    ...
    public BusinessPagerAdapter(Context context, List<Business.DataBean> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView!=null){
            ...
            ret= LayoutInflater.from(mContext).inflate(R.layout.business_list_item,parent,false);
