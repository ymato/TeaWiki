 ...
 */
public class DataPagerAdapter extends BaseAdapter {
    private Context mContext;
    private List<Data.DataBean> mData;
    private MyLruCache myLruCache;
    public DataPagerAdapter(Context context, List<Data.DataBean> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView!=null){
            ...
            ret= LayoutInflater.from(mContext).inflate(R.layout.data_list_item,parent,false);
