 ...
 */
public class WikiPagerAdapter extends BaseAdapter {
    private Context mContext;
    private List<Wiki.DataBean> mData;
    private MyLruCache myLruCache;
    public WikiPagerAdapter(Context context, List<Wiki.DataBean> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView!=null){
            ...
            ret= LayoutInflater.from(mContext).inflate(R.layout.wiki_list_item,parent,false);
